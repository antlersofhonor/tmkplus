...
local xx = -100; -- Code to change the direction of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
local yy = 450; -- Code to change the direction of the camera to the left or right for your opponent, Less = Left (They can be negative numbers), More = Right
local xx2 = 975; -- Code to change camera direction up or down for your opponent, Minus = Left (can be negative numbers), More = Right
local yy2 = 850;
local xx3 = 520;
local yy3 = 450;
...
if mustHitSection == true then
		setProperty('defaultCamZoom',0.8) -- Zoom that will make the camera for the enemy.
	else
		setProperty('defaultCamZoom',0.54) -- Zoom that will make the camera for boyfriend.
	end
	if del > 0 then
		del = del - 1
	end
